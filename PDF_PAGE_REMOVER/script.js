class PDFPageRemover {
    ...
    async removePages() {
        ...
        try {
            ...
            const downloadFileName = `${this.originalFileName}_STUDY_REMOVED.pdf`;
    ...
    downloadProcessedPDF() {
        ...
        // Generate filename with STUDY_REMOVED suffix
        const fileName = `${this.originalFileName}_STUDY_REMOVED.pdf`;
